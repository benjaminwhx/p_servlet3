package com.jd.jr.chapter4.web.upgrade.server;
    ...
    private class EchoReadListener implements ReadListener {
        ...
        public void onDataAvailable() throws IOException {
            ...
            while (is.isReady() && (ch = is.read()) != -1) {
                ...
                // 如果读取到的是CRLF,表示一次性读取完毕

                if (bufferLength >= 2 && buffer.charAt(bufferLength - 2) == '\r' &&
                        buffer.charAt(bufferLength - 1) == '\n') {
                    ...
                    if ("BYE\r\n".equals(data)) {
                        ...
                        is.close();
                        break;
                    } else {// 否则把数据加入队列,由writeListener写
